...
using BootstrapBS.Server.Services;
using Microsoft.JSInterop;

namespace BootstrapBS.Server.Components.Pages
{
    [JSModuleAutoLoader("Pages/Index.razor.js", JSObjectReference = true)]
    public partial class Index 
    {
        ...
        //private CodeSnippetService CodeSnippetService = new CodeSnippetService();
