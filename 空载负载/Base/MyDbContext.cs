...
namespace 空载负载.Base
{
    ...
    {   
        ...
        public DbSet<Table_NoloadRocreadInfo> NoloadRocreadInfo { get; set; } //空载记录信息
        public DbSet<Table_NoloadStandardInfo> NoloadStandardInfo { get; set; } //空载标准信息
        public DbSet<Table_UserTable> UserTable { get; set; } //标准信息


        public DbSet<Table_LoadRocreadInfo> LoadRocreadInfo { get; set; } //负载记录信息
        public DbSet<Table_LoadStandardInfo> LoadStandardInfo { get; set; } //负载标准信息

        public DbSet<Table_Template> Template { get; set; } //标准信息


        public DbSet<Table_InductionRecordInfo> InductionRecordInfo { get; set; } //感应记录信息
        public DbSet<Table_InductionStandardInfo> InductionStandardInfo { get; set; } //感应标准信息

        public DbSet<Table_UtilityRecordInfo> UtilityRecordInfo { get; set; } //工频记录信息
        public DbSet<Table_UtilityStandardInfo> UtilityStandardInfo { get; set; } //工频标准信息
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"server = .\JSQL2008; database = dewei3; pwd = sjk123; uid = sa; TrustServerCertificate = True;");
        }
