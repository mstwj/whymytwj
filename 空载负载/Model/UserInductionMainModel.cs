...
{
    public class UserInductionMainModel : ObservableObject
    {
        ...
        private float urms_vc, irms_ic, is_pv, pow_loss, flt_ukIopercent;
        private string flt_cosq;
        ...
        public string flt_CosQ { get => flt_cosq; set { SetProperty(ref flt_cosq, value); } }
