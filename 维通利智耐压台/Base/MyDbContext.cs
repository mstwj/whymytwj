...
namespace 维通利智耐压台.Base
{
    ...
    {   
        public DbSet<Tabel_User> naiya_user { get; set; } //样品信息
        public DbSet<Table_Product> naiya_product { get; set; } //记录信息
        public DbSet<Tabe_Record> naiya_record { get; set; } //标准信息
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"server = .\JSQL2008; database = dewei; pwd = sjk123; uid = sa; TrustServerCertificate = True;");
        }
